...
#ifndef WE_NEIGHBOUR_PROJECT_SWIFT_H
#define WE_NEIGHBOUR_PROJECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="we_neighbour_project",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20we_neighbour_project11AppDelegate")
...
SWIFT_CLASS("_TtC20we_neighbour_project17MainFlutterWindow")
